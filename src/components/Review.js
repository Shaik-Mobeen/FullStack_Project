...
export default function Review() {
  return (
    <div>
		 <h2 className='text'>What Our Client Says!</h2>
     <div class="outerdiv">
    ...
    <div class="innerdiv">
      ...
      <div class="div3 eachdiv">
        ...
        <div class="review dark">
          ...
          <p>“ Before joining the bootcamp, I’ve never written a line of code. step by step.  can only say wonderful things about the program. The entire curriculum and staff did not disappoint. They were very hands-on and I never had to wait long for assistance. The agile team project, in particular, was outstanding. It took my learning to the next level in a way that no tutorial could ever have.  ”</p>
        </div>
      </div>
